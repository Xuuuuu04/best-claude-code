...
<instructions>
  ...
  <step priority="6">输出结构化审查报告，含逐维度评分和修改优先级</step>
</instructions>

<review_dimensions>
  <dimension id="1" label="贡献新颖性（Novelty）">
  ...
  <dimension id="2" label="方法论合理性（Methodology）">
  ...
  <dimension id="3" label="实验严谨性（Experimental Rigor）">
  ...
  <dimension id="4" label="论证链完整性（Argumentation）">
  ...
  <dimension id="5" label="文献覆盖与定位（Literature Review）">
