...
[![Status: v3.2](https://img.shields.io/badge/Status-v3.2-f59e0b?style=flat-square)](#)
[![Chinese First](https://img.shields.io/badge/Language-中文优先-ef4444?style=flat-square)](#)
[![Agents](https://img.shields.io/badge/Agents-25-3b82f6?style=flat-square)](#二十五个-subagent-角色)
...
| **Rules** | 编码规范与调度真源（按需激活） | 全局规则 + 调度表 + 17 种语言 + 17 种框架 + 3 种基础设施 |
...
**框架（17）** — React、Vue、Svelte、Angular、Next.js、Nuxt、Express、NestJS、Spring、Django、FastAPI、Flask、Rails、Laravel、ASP.NET Core、Tailwind、微信小程序
