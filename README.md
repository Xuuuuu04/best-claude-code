...
[![Agents](https://img.shields.io/badge/Agents-36-3b82f6?style=flat-square)](#二十九-subagent-角色)
[![Rules](https://img.shields.io/badge/Rules-50-8b5cf6?style=flat-square)](#支持的技术栈)
[![Skills](https://img.shields.io/badge/Skills-52-06b6d4?style=flat-square)](#系统架构)
...
| **Skills** | 可调用的知识 / 工作流 | 47 个，分三类：系统运维命令（disable-model-invocation）、领域协议（Agent 预加载）、参考文档 |
| **Subagents** | 隔离上下文的工作者 | 34 个专职角色，覆盖需求/设计/研究/实现/审查/测试/验收/部署/元治理/论文/仓颉/昇腾/就业/外包 |
...
| Agent 拓扑 | ✅ 核心流水线 + 专项卫星层，共 34 角色 | N/A | ⚠️ 通常按技术栈，维护成本高 |
