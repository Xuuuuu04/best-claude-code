...
### Skills(11 个,位于 `skills/bcc-<name>/SKILL.md`,统一 `/bcc-` 前缀）
...
Activation Persona 只对 Explore / general-purpose / developer 类 subagent 生效;reviewer 有自己的固定人设。
...
### 3. Developer/Reviewer 双角(量化 review + 对抗性收敛)
...
真正不可替代的——跨会话记忆、子代理通信、量化 review 收敛、执行纪律——就是这 21 个。
